...
if plik:
    ...
    st.image(obraz, caption="Report preview", use_container_width=True)
        ...
        with st.spinner("AI is analysing design, distractions and attention points..."):
            try:
                if typ_raportu == "Business":
                    reqs = (
                        "You are an experienced, pragmatic C-level business director, not a corporate bot. "
                    ...
                    reqs = (
                        "You are a seasoned sales and funnel optimization expert (Sales Director). "
                    ...
                    reqs = (
                        "You are an operations and UX usability expert. "
